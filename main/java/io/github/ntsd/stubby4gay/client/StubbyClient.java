...
import io.github.ntsd.stubby4gay.server.JettyFactory;
...
public final class StubbyClient {
     ...
     *
     * @param host      host that stubby4gay is running on
     * @param uri       URI for the HTTP request
     * @param stubsPort port that stubby4gay Stubs is running on
    ...
    /**
     * Makes GET HTTP request to stubby over TLS on stubby4gay default TLS port: 7443
     *
     * @param host host that stubby4gay is running on
     * @param uri  URI for the HTTP request
     * @return StubbyResponse with HTTP status code and message from the server
    ...
    /**
     * Makes GET HTTP request to stubby over TLS on stubby4gay
     *
     * @param host host that stubby4gay is running on
     * @param uri  URI for the HTTP request
     * @param port TLS port
    ...
    /**
     * Makes PUT HTTP request to stubby over TLS on stubby4gay default TLS port: 7443
     * <p></p>
     * Also can set basic authorisation HTTP header using encoded credentials (if provided).
     * The credentials should be base-64 encoded using the following format - username:password
     *
    ...
    /**
     * Makes DELETE HTTP request to stubby over TLS on stubby4gay default TLS port: 7443
     * <p></p>
     * Also can set basic authorisation HTTP header using encoded credentials (if provided).
     * The credentials should be base-64 encoded using the following format - username:password
     *
     ...
     * @param host   host that stubby4gay is running on
     * @param uri    URI for the HTTP request
     * @param port   port that stubby4gay Stubs is running on
