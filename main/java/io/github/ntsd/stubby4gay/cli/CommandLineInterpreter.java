...
package io.github.ntsd.stubby4gay.cli;
...
import static io.github.ntsd.stubby4gay.utils.JarUtils.readManifestImplementationVersion;
...
public final class CommandLineInterpreter {
    ...
    public void printHelp() {
        ...
        final String command = String.format("%sjava -jar stubby4gay-x.x.xx.jar", BR);
        formatter.printHelp(command, OPTIONS, true);
    }

    /**
     * Prints current stubby4gay version to the console
     */
    @CoberturaIgnore
